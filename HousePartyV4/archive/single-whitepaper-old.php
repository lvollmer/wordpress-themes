...
get_header(); ?>
		...
		<div id="container" class="events_container whitepapersingle">
			<form id="myform" method="post" name="myform" action=""><input type="hidden" name="okas" value="2" /></form>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<div id="tellusabout">
					<h2>Tell us about yourself to get the download link.</h2>
					<?php echo do_shortcode('[contact-form-7 id="3013" title="Tell us about your self"]');?>
					</div>
					<div id="readytodownload">
						<h2>Thank you, download the report<br/> </h2>
						<p>&nbsp;</p>
						<?php $video_url = get_post_meta(get_the_ID(), 'download-url', true);
						if( !$video_url )
							$video_url = get_permalink();
						?>
						<a href="<?php echo $video_url;?>" target="_blank">
						<div class="media_button" style="margin-left: 170px;width: 100px;">
							Download
						</div>
						</a>
